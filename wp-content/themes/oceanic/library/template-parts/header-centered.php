<?php
if( get_theme_mod( 'oceanic-show-header-top-bar', customizer_library_get_default( 'oceanic-show-header-top-bar' ) ) ) :
?>
    ...
    <div class="site-top-bar border-bottom">
        ...
        <div class="site-container">
            ...
            <div class="site-top-bar-right">
                ...
                <?php
                if ( oceanic_is_woocommerce_activated() && get_theme_mod( 'oceanic-header-shop-links', customizer_library_get_default( 'oceanic-header-shop-links' ) ) ) {
